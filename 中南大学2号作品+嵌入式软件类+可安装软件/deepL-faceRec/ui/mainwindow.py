...
class Ui_MainWindow(QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        palette = QPalette()
        pix=QPixmap("ui/background2.jpg")
        ...
        self.gridLayout_buttons.setSpacing(20)
    ...
    def btn_face_clicked(self):
        ...
        self.facerec = ui.FaceRec(self)#人脸识别界面
        self.facerec.setModel(self.model)#传入模型
        self.facerec.setVideo(self.video)#传入video
    ...
    def btn_register_clicked(self):
        ...
        self.register = ui.FaceRegister(self)#人脸录入界面
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_welcome.setText(str(u"人脸识别系统"))
        self.btn_face.setText(u"人脸识别")
        self.btn_register.setText(u"人脸录入")
        self.btn_exit.setText("退出系统")
